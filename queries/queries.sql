...
-- Drop the retirement table to re-create it
...
SELECT d.dept_name, dm.dept_no, dm.emp_no, dm.from_date, dm.to_date
FROM departments d
INNER JOIN dept_manager dm
ON d.dept_no = dm.dept_no
;

-- Create aliases from above
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Create a new table of emp_info
SELECT emp_no,
    first_name,
    last_name,
    gender
